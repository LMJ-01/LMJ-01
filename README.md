...
* **Key Role**:
  * **멀티 소셜 로그인 및 보안 아키텍처 설계**: Spring Security와 OAuth2(Kakao/Google), JWT 토큰 체계를 결합한 견고한 보안 인증 환경 구축
  * **하이브리드 데이터 매핑 및 파이프라인**: Selenium과 BeautifulSoup4를 활용한 씨네21 데이터 크롤링 및 TMDB API 데이터 정밀 동기화
